  ...
  <div class="costAccounting-view">
    <div class="right-view">
      <div class="top-view">
        ...
        <div class="item-view">
          <el-checkbox v-model="checked" style="color:white;">是否通过下级部门汇总生成</el-checkbox>
        </div>
      </div>
            ...
            >
              ...
              <div class="content">
                <textarea
                  readonly
                  id="description"
                >{{areaConfig.description}}</textarea>
              </div>
            </div>
          </div>
          <div class="bottom">
...
export default {
  ...
  created() {
    this.initData();
    switch (this.$route.query.energyType) {
      case 1:
        this.deviceName = "电表";
        break;
      case 2:
