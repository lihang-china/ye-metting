<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="调试时间" align="center" width="150">
        <template>
...
export default {
  name: "DeviceChannel",
  components: { ChannelView, HisDeviceData, RealDeviceData, Timer },
  data() {
    return {
      // 按钮图片
  ...
  watch: {
    isReg(newVal, oldVal) {
      ...
      if (newVal) {
        ...
        // 发起ws请求
        initWebSocket(
          "ws://49.235.235.167:8080/websocket",
          obj,
          this.wsMessage,
          this.wsError
        );
