<template>
  <div class="dashboard-editor-container">
    <div class="top">
      ...
      <div class="top-right">
        <div class="top-date">
          <div style="margin-right: 5px; font-size: 36px">
            <svg-icon icon-class="fineday" />
          </div>
          <div style="text-align: center">
            ...
            <div style="font-weight: normal; font-size: 12px">
              {{ currentTime | formatDate("YYYY年MM月DD日") }}
            </div>
          </div>
        </div>
        ...
        <!-- <div class="top-userinfo">管理员<i class="el-icon-caret-bottom" /></div> -->
        <div class="dropdown user-menu">
          <div class="menu-item">
            <el-dropdown>
              <span>
                管理员(编辑模式)<i class="el-icon-arrow-down el-icon--right"></i>
              </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  <a @click="goPage('Lead')">主菜单</a>
                </el-dropdown-item>
                <el-dropdown-item>
                  <a @click="goPage('GisIndex')">演示模式</a>
                </el-dropdown-item>
                <!-- <el-dropdown-item>
                  <a @click="goPage('GisEdit')">编辑模式</a>
                </el-dropdown-item> -->
                <el-dropdown-item>
                  <a @click="goBase()">基础设置</a>
                </el-dropdown-item>
                <el-dropdown-item>
                  <a @click="logout()">注销</a>
                </el-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    openLayer(item) {
      if (item.menuType) {
        this.IFSrc =
          "/gis-app/coordinate?type=" +
          item.menuType +
          "&icon=" +
          item.icon +
          "&menuName=" +
          item.menuName;
        //this.IFSrc = "https://www.baidu.com/";
      }
      if (item.menuClass === "U") {
        this.IFSrc = item.url;
      }
