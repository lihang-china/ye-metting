    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          >
            ...
            <el-form-item label="数据类型">
              <el-radio-group v-model="activeData.__config__.dataType" size="small">
                <el-radio-button label="dictionary">字典</el-radio-button>
            ...
            <template v-if="activeData.__config__.dataType === 'dictionary'">
              <el-form-item label="字典类型">
                <el-select
                  v-model="activeData.__config__.dictType"
                  clearable
                  filterable
                  placeholder="请选择字典类型"
                >
            ...
            <template v-if="activeData.__config__.dataType === 'dynamic'">
              <el-form-item label="远程地址">
                <el-input v-model="activeData.props.props.url" placeholder="请输入远程地址" />
              </el-form-item>
          ...
          <el-form-item v-if="activeData.__config__.tag === 'el-cascader'" label="返回各级菜单的值">
            <el-switch v-model="activeData.props.props.emitPath" />
          </el-form-item>
